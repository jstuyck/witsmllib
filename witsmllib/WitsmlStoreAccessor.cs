...
namespace witsmllib
{
    ...
    { // : Stub {
         ...
         */
        //   [MethodImpl(MethodImplOptions.Synchronized)] 
        internal String getStatusMessage(short statusCode)
        { //throws RemoteException {
         ...
         */
        [MethodImpl(MethodImplOptions.Synchronized)]
        internal WitsmlResponse getServerCapabilities()
        { //throws RemoteException {
            Stopwatch sWatch = new Stopwatch();
            string capabilitiesOutXml, message;
            sWatch.Start();
            ...
            return new WitsmlResponse(capabilitiesOutXml, (int)statusCode, message, sWatch.ElapsedMilliseconds);
        }
         ...
         */
        [MethodImpl(MethodImplOptions.Synchronized)]
        internal WitsmlResponse get(String wmlType, String queryXml)
        { //throws RemoteException {
            if (wmlType == null)
            ...
            return new WitsmlResponse(responseXml, (int)statusCode, message, sWatch.ElapsedMilliseconds);
        }
        ...
        internal WitsmlResponse delete(String wmlType, String deleteXml)
        {
            ...
            if (wmlType == null)
                throw new ArgumentNullException("wmlType cannot be null");
            if (deleteXml == null)
                throw new ArgumentNullException("deleteXml cannot be null");
            ...
            return new WitsmlResponse(null, (int)statusCode, message, sWatch.ElapsedMilliseconds);
        }
         ...
         */
        //[MethodImpl(MethodImplOptions.Synchronized)] 
        WitsmlResponse add(String wmlType, String addXml)
        {
            if (wmlType == null)
                throw new ArgumentNullException("wmlType cannot be null");
            if (addXml == null)
                throw new ArgumentNullException("addXml cannot be null");
