...
namespace witsmllib.v140
{
    ...
    sealed class WitsmlTrajectory : witsmllib.WitsmlTrajectory
    {
        ...
        static String getQuery(String id, params String[] parentId)
        {
            ...
            String query = "<trajectorys xmlns=\"" + WitsmlVersion.VERSION_1_4_0.getNamespace() + "\">" +
        ...
        void update(XElement element)
        {
            ...
            foreach (var itms in trajectoryStationElements)
            {
                stations.Clear();
                break;
            }
            ...
            int i = 0;
            foreach (Object subElement in trajectoryStationElements.Elements())
            {
